...
describe('Dialog', () => {
  describe('rendering', () => {
    it('renders with role="dialog"', () => {
      render(<Dialog {...defaultProps}><p>Content</p></Dialog>);
    ...
    it('renders with the provided aria-label', () => {
      render(<Dialog {...defaultProps} aria-label="My dialog"><p>Content</p></Dialog>);
      expect(screen.getByRole('dialog')).toHaveAttribute('aria-label', 'My dialog');
    });

    it('renders children inside the dialog', () => {
      render(<Dialog {...defaultProps}><p>Dialog content</p></Dialog>);
  ...
  describe('closing behaviour', () => {
    ...
    it('calls onClose when the overlay (backdrop) is clicked', () => {
      const { container } = render(<Dialog {...defaultProps}><p>Content</p></Dialog>);
  ...
  describe('scroll lock', () => {
    ...
    it('restores body overflow when unmounted', () => {
      const { unmount } = render(<Dialog {...defaultProps}><p>Content</p></Dialog>);
      unmount();
